...
from grading_utils import BruhTestRunner, score
...
class SeamCarverTester(unittest.TestCase):
    ...
    def sctest_000_calculate_energy_ex1(self):
        ...
        out = ex1.energy(1, 2)
        self.assertAlmostEqual(out, 52024.0)
    ...
    def sctest_001_calculate_energy_ex1(self):
        ...
        ex1 = SeamCarver(Image.open('data/3x4.png'))
        out = ex1.energy(1, 0)
        self.assertAlmostEqual(out, 52020.0)
    ...
    def sctest_002_calculate_energy_ex1(self):
        ...
        ex1 = SeamCarver(Image.open('data/3x4.png'))
        out = ex1.energy(1, 1)
        self.assertAlmostEqual(out, 52225.0)
    ...
    @score(2)
    def sctest_015_remove_horizontal_seam_width1(self):
        'Throw SeamError if attempted to remove invalid horizontal seam'
        ex1 = SeamCarver(Image.open('data/3x4.png'))
        seam = [0, 0, 0]
        for _ in range(3):
...
if __name__ == '__main__':
    ...
    suite = unittest.defaultTestLoader.loadTestsFromTestCase(SeamCarverTester)
    runner = BruhTestRunner(category='seamcarver')
    runner.run(suite)
